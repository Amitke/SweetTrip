    ...
    <section className={`${whyChooseStyles.policy} pt-10 pb-10`}>
      <div className="container mx-auto">
        <div className={`flex-col flex pl-4 pr-4 ${whyChooseStyles.flex}`}>
          ...
          <h3 className="font-bold mt-5">Types of Buses Available for Hire in Varanasi</h3>
          <h4 className="mt-2">Luxury Bus Rental in Varanasi</h4>
          ...
          <h4 className="mt-4">Mini Bus on Rent in Varanasi</h4>
          ...
          <h4 className="mt-4">Deluxe Bus Rental in Varanasi</h4>
          ...
          <h3 className="mt-5 font-bold">Booking Bus Service in Varanasi is Now Easier Than Ever</h3>
