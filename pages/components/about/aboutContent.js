    ...
    <section className="about-content pt-10 pb-10">
      <div className="container mx-auto">
        <div className="flex-col flex pl-4 pr-4">
          ...
          <p>Varanasi, the spiritual heart of India, offers an unparalleled blend of history, culture, and divinity. With Sweet Trip, you get trusted and comfortable <strong>car rental services in Varanasi</strong> to explore this mystical city at your own pace. Whether you're on a short visit with our <strong>Varanasi 2-day tour package</strong> or planning a detailed itinerary, our fleet of well-maintained vehicles and professional drivers ensure a safe and enjoyable ride.</p>
          ...
          <ul className="mt-2">
            <li>●	<strong>Car Rental in Varanasi</strong> – Comfortable, affordable, and reliable cabs for all your travel needs.</li>
            <li>●	<strong>Morning Boat Ride in Varanasi</strong> – Witness the spiritual charm of the ghats at sunrise.</li>
            <li>●	<strong>Best Boat Ride in Varanasi</strong> – Experience the mesmerising Ganga Aarti from the holy river.</li>
            <li>●	<strong>Best Places to Stay in Varanasi</strong> – Get expert recommendations for a comfortable stay.
            </li>
          </ul>
          ...
          <p>Ayodhya, steeped in mythology and devotion, is a must-visit destination. Explore Ram Janmabhoomi, Hanuman Garhi, and other revered landmarks with our <strong>Ayodhya tour package</strong>. We also provide hotel bookings in Ayodhya to make your stay comfortable and convenient.</p>
