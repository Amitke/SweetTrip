    ...
    >
      <div className="container mx-auto">
        ...
        >
          ...
          <ul>
            <li>
              ● Visit the Akshayavat (Immortal Banyan Tree), located inside the
              Allahabad Fort area. It holds immense religious importance in
              Hindu mythology.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ● Stop by this ancient Shiva temple, located near Saraswati Ghat,
              and enjoy its serene environment.
            </li>
          </ul>
          <h3 className="mb-2 mt-3">Afternoon</h3>
          ...
          <ul>
            <li>
              ● Head to Saraswati Ghat for a beautiful sunset view by the Yamuna
              River.
            </li>
            <li>
          ...
          <ul>
            <li>
              ● Explore local bazaars like Chowk and Civil Lines for souvenirs,
              handicrafts, and religious items.
            </li>
            <li>
              ● Try local delicacies like kachori-sabzi, jalebi, and street food
              at Loknath or Civil Lines.
            </li>
          </ul>
        </div>
      </div>
